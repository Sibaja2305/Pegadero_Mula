...
public class Factura {
    ...
    private Date F_Factura;

    public Factura(int C_Factura, int C_Pedido, int C_Metodo_Pago, int C_Sucursal, int C_Impuesto, double M_Total, Date F_Factura) {
     ...
     */
    public void setF_Factura(Date F_Factura) {
        this.F_Factura = F_Factura;
    }

    @Override
    public String toString() {
        return "Factura{" + "C_Factura=" + C_Factura + ", C_Pedido=" + C_Pedido + ", C_Metodo_Pago=" + C_Metodo_Pago + ", C_Sucursal=" + C_Sucursal + ", C_Impuesto=" + C_Impuesto + ", M_Total=" + M_Total + ", F_Factura=" + F_Factura + '}';
    }
