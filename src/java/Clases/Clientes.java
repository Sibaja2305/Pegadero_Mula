...
private String N_Numero_Telefono;
    ...
    public Clientes(int C_Cliente, int C_Direccion_Fisica, String C_Cedula, String N_Numero_Telefono) {
    ...
    public String toString() {
        return "Clientes{" + "C_Cliente=" + C_Cliente + ", C_Direccion_Fisica=" + C_Direccion_Fisica + ", C_Cedula=" + C_Cedula + ", N_Numero_Telefono=" + N_Numero_Telefono + '}';
    }
